...
* [1.1 - Máquinas Virtuais e Contêineres](1-introducao/1-1-maquinas-vistuais-e-conteineres.md)
* [1.2 DevOps e Docker](1-introducao/1-2-devops-e-docker.md)
* [1.3 Configuração do Ambiente](1-introducao/1-3-configuracao-do-ambiente.md)

## 2. Produção <a id="2-producao"></a>

* [2.1 Produção: o fim ou o início?](2-producao/2-1-producao-o-fim-ou-o-inicio.md)
* [2.2 Ambiente de Produção](2-producao/2-2-ambiente-de-producao.md)
* [2.3 Instalação do Servidor de Banco de Dados](2-producao/2-3-instalacao-do-servidor-de-banco-de-dados.md)
* [2.4 Instalação do Servidor de Web](2-producao/2-4-instalacao-do-servidor-de-web.md)

## 3. Monitoramento <a id="3-monitoramento"></a>

* [3.1 Introdução](3-monitoramento/3-1-introducao.md)
* [3.2 Configurando o Servidor de Monitoramento](3-monitoramento/3-2-configurando-o-servidor-de-monitorament.md)
* [3.3 Monitorando Servidores do Ambiente de Produção](3-monitoramento/3-3-monitorando-servidores-do-ambiente-de-producao.md)
* [3.4 Comandos de Verificação do Nagios](3-monitoramento/3-4-comandos-de-verificacao-do-nagios.md)
* [3.5 Criando Verificações Mais Específicas](3-monitoramento/3-5-criando-verificacoes-mais-especificas.md)
* [3.6 Criando Alertas](3-monitoramento/3-6-criando-alertas.md)
* [3.7 Recuperando de Problemas](3-monitoramento/3-7-recuperando-de-problemas.md)
...
* [Untitled](7-topicos-avancados/untitled.md)
